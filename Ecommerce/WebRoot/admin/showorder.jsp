...
<body>
	<div id="wrapper">
			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                        ...
                        <li><a href="/Ecommerce/showaorder.action"class="active">查看订单</a></li>
    	...
    	<tr>
    		...
    		<td align="center"><a href="deleteorder.action?spid=<s:property value='#allorder.SP.SPId' />&uid=<s:property value='#allorder.consumer.UId' />">删除</a></td>
    	</tr>
    	</s:iterator>
    </table>
					<h3>&nbsp;</h3>
