...
<body>
	<div id="wrapper">
			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href='/Ecommerce/showsp.action'class="active">管理发布的产品信息</a></li>
                ...
                <h2><a href="#">Admin用户</a> &raquo; <a href="#" class="active">管理发布的产品信息</a></h2>
		...
		<table border="0.5px" width="700px" class="style" style="margin-top: 50px;">
			...
			<s:iterator value="%{#request.allsp}" var="allsp">
    	<tr>
    		<td align="center"><s:property value="#allsp.SPId" /></td>
    		<td align="center"><s:property value="#allsp.product.PId" /></td>
    		<td align="center"><s:property value="#allsp.product.PName" /></td>
    		<td align="center"><s:property value="#allsp.product.price" /></td>
    		<td align="center"><s:property value="#allsp.product.num" /></td>
    		<td align="center"><s:property value="#allsp.seller.SName" /></td>
    		<td align="center"><a href="deletesp.action?spid=<s:property value='#allsp.SPId' />">删除</a></td>
