	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	<li><a href="/Ecommerce/seller/addproduct.jsp"class="active">上传产品</a></li>
                ...
                <h2><a href="#">注册用户</a> &raquo; <a href="#" class="active">上传产品</a></h2>
...
<form action="../addproduct.action" method="post">
			<table width="400px" border="1px" align="center" class="style"
                ...
                <tr>
					...
					<td>
					<input type="text" name="newproduct.PName"/>
				...
				<tr>
					...
					<td>
					<input type="text"  name="newproduct.description"/>
				...
				<tr>
					...
					<td>
					<input type="text"  name="newproduct.price"/>
				...
				<tr>
					...
					<td>
					<input type="text"  name="newproduct.num"/>
				...
				<tr>
					...
					<td>
					<input type="text"  name="newproduct.type"/>
				...
				<tr>
					...
					<td>
					<input type="text"  name="newproduct.image"/>
				...
				<tr>
					...
					<td>
					<input type="text" value="${sessionScope.consumer.getUName()}" readonly="readonly" name="newproduct.SName"/>
