...
<body>
	<div id="wrapper">
			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href='/Ecommerce/showup.action'class="active">查看上架产品</a></li>
                ...
                <h2><a href="#">注册用户</a> &raquo; <a href="#" class="active">查看上架产品</a></h2>
    	...
    	<tr>
    		...
    		<td align="center"><s:property value="#ssp.product.type" /></td>
    		<td align="center"><a href="cancelup.action?spid=<s:property value='#ssp.SPId' />">下架</a></td>
