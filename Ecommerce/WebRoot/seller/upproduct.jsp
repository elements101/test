...
<body>
	<div id="wrapper">
			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href='/Ecommerce/spproduct.action'class="active">产品上架</a></li>
                ...
                <h2><a href="#">注册用户</a> &raquo; <a href="#" class="active">产品上架</a></h2>
		...
		<table border="0.5px" width="700px" class="style" style="margin-top: 50px;">
			...
			<s:iterator value="%{#request.sproduct}" var="sproduct">
    	<tr>
    		<td align="center"><s:property value="#sproduct.PId" /></td>
    		<td align="center"><s:property value="#sproduct.PName" /></td>
    		<td align="center"><s:property value="#sproduct.description" /></td>
    		<td align="center"><s:property value="#sproduct.price" /></td>
    		<td align="center"><s:property value="#sproduct.num" /></td>
    		<td align="center"><s:property value="#sproduct.type" /></td>
    		<td align="center"><a href="upproduct.action?upid=<s:property value='#sproduct.PId' />">上架</a></td>
