		...
		<form action="editproduct.action" method="post">
			<table width="400px" border="1px" align="center" class="style"
				...
				<tr>
					...
					<td>
					<input type="text" value="${requestScope.selectproduct.PId}" readonly="readonly" name="newproduct.PId"/>
				...
				<tr>
					...
					<td>
					<input type="text" value="${requestScope.selectproduct.PName}" name="newproduct.PName"/>
				...
				<tr>
					...
					<td>
					<input type="text" value="${requestScope.selectproduct.description}" name="newproduct.description"/>
				...
				<tr>
					<td>商品单价：</td>
					<td>
					<input type="text" value="${requestScope.selectproduct.price}" name="newproduct.price"/>
				...
				<tr>
					<td>商品数量： </td>
					<td>
					<input type="text" value="${requestScope.selectproduct.num}" name="newproduct.num"/>
				...
				<tr>
					<td>商品类型：</td>
					<td>
					<input type="text" value="${requestScope.selectproduct.type}" name="newproduct.type"/>
				...
				<tr>
					<td></td>
					<td>
					<input type="hidden" value="${requestScope.selectproduct.SName}" name="newproduct.SName"/>
