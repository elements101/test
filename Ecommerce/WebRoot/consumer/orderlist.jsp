...
<body>
	<div id="wrapper">
			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href='/Ecommerce/orderlist.action'class="active">查看订单</a></li>
                ...
                <h2><a href="#">注册用户</a> &raquo; <a href="#" class="active">订单查询</a></h2>
    	...
    	<tr>
    		...
    		<td align="center"><a href="selectcons.action?spid=<s:property value='#ors.SP.SPId' />&comment=<s:property value='#ors.comment' />" >评价</a></td>
    	</tr>
    	</s:iterator>
	</table>
					<h3>&nbsp;</h3>
