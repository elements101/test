...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div id="header_right">
            ...
            <p>
            	Shopping Cart: <strong>0 items</strong> ( <a href="cartlist.action">Show Cart</a> )
			</p>
		</div>
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<a  rel="lightbox[portfolio]" href="images/product/10_l.jpg"><img src="images/product/${param.image}" alt="image" /></a>
            </div>
            <div class="content_half float_r">
            <form action="cartadd.action?spid=${param.spid}" method="post" id="form1">
                <table>
                    <tr>
                    ...
                    <tr>
                    	<td>Quantity</td>
                        <td><input type="text" name="num" value="1" style="width: 20px; text-align: right" /></td>
                    </tr>
                </table>
