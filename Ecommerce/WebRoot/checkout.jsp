...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div id="header_right">
            ...
            <p>
            	Shopping Cart: <strong>${sessionScope.cout} items</strong> ( <a href="shoppingcart.html">Show Cart</a> )
			</p>
		</div>
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
            ...
            <div class="content_half float_l checkout">
                ...
                <br />
              Address:
				<input type="text" value="${sessionScope.consumer.getAddress()}" style="width:300px;"  />
                <br />
                <br />
              City:
                <input type="text"  style="width:300px;"  />
            ...
            <div class="content_half float_r checkout">
            	E-MAIL
				<input type="text" value="${sessionScope.consumer.getEmail()}" style="width:300px;"  />
                <br />
                <br />
          PHONE<br />
                ...
                <input type="text" value="${sessionScope.consumer.getPhone()}" style="width:300px;"  />
            </div>
            
            <div class="cleaner h50"></div>
            <h3>SHOPPING CART</h3>
            <h4>TOTAL AMOUNT:${param.price}</h4>
            ...
            <table style="border:1px solid #CCCCCC;" width="100%">
                <tr>
                    ...
                    <td><a href="buyproduct.action" class="more">PAYPAL</a></td>
                </tr>
                <tr>
